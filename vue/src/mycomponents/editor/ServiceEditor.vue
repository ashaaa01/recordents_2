<template>
  ...
  <div :class="[ selectOptions ? 'grid gap-3 grid-cols-12' : '' ] ">
    ...
    <!-- Question Type -->
    <div v-if="selectOptions" class="mt-3 col-span-3">
      <label for="question_type" class="block text-sm font-medium text-gray-700"
        >Select Options Type</label
      >
      <select
        id="question_type"
        name="question_type"
 ...
 <!--  <div class="mt-3 col-span-9 ">
  ...
  <!-- Data -->
    ...
    <div v-if="shouldHaveOptions()" class="mt-2">
      <h4 class="text-sm font-semibold mb-1 flex justify-between items-center dark:text-slate-300">
        Options
      ...
      >
        You don't have any services defined
      </div>
      <!-- Option list -->
      <div
