      ...
      <tr v-for="services in servicesPaginated" :key="services.id">
        ...
        <td class="before:hidden lg:w-1 whitespace-nowrap">
          <BaseButtons type="justify-start lg:justify-end" no-wrap>
            <BaseButton color="info" :icon="mdiEye" small @click="isModalActive = true, selectedRecord = services" />
            <BaseButton color="success" :icon="mdiPencil" small @click="isModalEdit = true, changeStatus = {id: services.id, book_status: services.book_status}" />
          </BaseButtons>
        </td>
      </tr>
    </tbody>
